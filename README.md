 ...
 ### 👨‍💻 Немного обо мне  <br>
Я Frontend-разработчик с более чем 3 годами коммерческого опыта, специализируюсь на создании
масштабируемых веб-приложений на Angular.
<br>
<br>
За это время я:
<br>
🚀 Работал как единственным фронтендером, так и частью сильных команд.<br>
🧱 Разрабатывал проекты с монолитной архитектурой и микрофронтендами.<br>
📦 Имею опыт работы с крупной кодовой базой в монорепозиториях (Nx).<br>
🧩 Создавал самые разные модули — от простых форм до сложных интерактивных компонентов.<br>
🧠 Люблю разбираться в глубине: RxJS, NgRx, архитектура, оптимизации, паттерны.<br>
🎯 Всегда ищу взвешенные решения, исходя из требований задачи и целей бизнеса.<br>

### 🔧 Основной стек:
***Angular*** · **TypeScript** · **JavaScript** · **RxJS** · **NgRx** · **Nx** · **HTML** · **SCSS**
<br>
<br>
### ✨ Интересы
В свободное время люблю бывать на природе 🌿 <br> 
...
<div style="display: flex; align-items: flex-start; gap: 20px;">
  <a href="https://github.com/gtixang/github-readme-stats">
    <img
      style="height: 150px; max-width: 300px; object-fit: contain;"
