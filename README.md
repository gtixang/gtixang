...
🚀 Работал как единственным фронтендером, так и частью сильных команд.
🧱 Разрабатывал проекты с монолитной архитектурой и микрофронтендами.
📦 Имею опыт работы с крупной кодовой базой в монорепозиториях (Nx).
🧩 Создавал самые разные модули — от простых форм до сложных интерактивных компонентов.
🧠 Люблю разбираться в глубине: RxJS, NgRx, архитектура, оптимизации, паттерны.
🎯 Всегда ищу взвешенные решения, исходя из требований задачи и целей бизнеса.
