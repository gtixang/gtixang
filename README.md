 ...
 ### 👨‍💻 Немного обо мне  <br>
Я Frontend-разработчик с опытом, специализируюсь на создании масштабируемых веб-приложений на Angular.
<br>

🚀 Работал как единственным Frontend-разработчиком, так и в командах.<br>
🧱 Также работал, как с монолитной архитектурой, так и с микрофронтами.<br>
