...
За это время я:
<br>
🚀 Работал как единственным Frontend-разработчиком, так и в составе команд.<br>
🧱 Имею опыт как с монолитной архитектурой, так и с микрофронтендами.<br>
📦 Работал с крупной кодовой базой в монорепозиториях (Nx).<br>
🧩 Разрабатывал различные функциональные модули — от простых форм до сложных компонентов.<br>
🧠 Люблю разбираться в сложных задачах и технических деталях.<br>
🎯 Умею находить взвешенное решение на требования задачи и цели бизнеса.<br>

### 🔧 Основной стек:
**Angular** · **TypeScript** · **JavaScript** · **RxJS** · **NgRx** · **Nx** · **HTML** · **SCSS** · **Git** 
<br>
<br>
### ✨ Интересы
